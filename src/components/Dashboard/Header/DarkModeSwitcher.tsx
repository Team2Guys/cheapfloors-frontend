  ...
  return (
    <li>
      ...
      >
        ...
        />
        <span
          className={`absolute top-1/2 left-[3px] flex_center h-4 xs:h-6 w-4 xs:w-6 -translate-y-1/2 translate-x-0 rounded-full bg-white shadow-switcher duration-200 ease-in-out ${
