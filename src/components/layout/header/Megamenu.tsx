...
> = ({ label, href, submenu, products }) => {
  ...
  return (
    ...
    >
      <Link
        className={`text-11 xl:text-13 2xl:text-13 3xl:text-base capitalize ${pathname === `/${href}` ? 'bg-gray-light p-[6px] xl:p-2 rounded-xl' : 'hover:bg-gray-light p-[6px]  xl:p-2 rounded-xl '}`}
        href={`/${href}`}
      >
        {label}
      </Link>
