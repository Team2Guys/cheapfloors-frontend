export const termsConditionsData = [
  ...
  },
  {
    ...
    content: [
      "Please read these terms before placing an order. Here are some important details about us, such as who we are, how we will supply flooring solutions to your home, how we will change or end the contract, what to do if something goes wrong, and other important things. If you believe that these terms need to be changed or if you see any mistakes, kindly contact us. You confirm that you have read, understood, and agreed to these terms by using our website. You can always stop using our website or services if you don't agree with these terms."
    ]
  },
  {
    title: 'General Terms',
  ...
  },
  {
    ...
    content: [
      'The expected delivery times are shown at checkout and depend on the location, order amount, and form of shipment. No matter how hard we try, supply chain interruptions, carrier issues, or severe weather might create unexpected delays.'
    ]
  },
  {
    heading: ['Shipping Fees'],
    content: [
      'Based on your location and the size of your order, the shipping cost is calculated at checkout. The cost of delivery is not refundable after your order has been dispatched.'
    ]
  },
  {
    heading: ['Receiving Your Order'],
    content: [
      'When your order is delivered, please check it. Please let us know within 24 hours if your flooring comes damaged, flawed, or incorrect so that we may take care of the problem right away. There can be extra costs if your order needs liftgate service or special handling.'
    ]
  },
  {
    ...
    content: [
      'Only items that are delivered broken, flawed, or incorrectly may be returned. Returns are not accepted for:'
    ],
    subItems: [
  ...
  },
  {
    ...
    content: [
      "Depending on the type and brand, each of our flooring items is covered by a manufacturer's guarantee. For warranty information, please visit the page for each product. "
    ]
  },
  {
    ...
    contentend: [
      'For warranty claims, please retain proof of purchase and contact our support team for assistance.'
    ]
  },
  {
