export const privacyPolicyData = [
  ...
  },
  {
    ...
    content: [
      'Unless the following situations occur, your personal information is never rented, sold, or given to third parties:'
    ],
    subItems: [
  ...
  },
  {
    ...
    content: [
      'Cookies and tracking technologies are used to improve your online experience. These might include:'
    ],
    subItems: [
    ...
    contentend: [
      "In your browser's options, you may control or reject cookies, however, doing so can affect the way a website works."
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      'Our website may include links to other websites. The privacy policies and content of any linked websites are beyond our control. Before sharing sensitive information, we suggest reviewing their privacy rules.'
    ]
  },
  {
    title: 'Updates to This Policy',
    content: [
      'This privacy policy might be changed at any time. This page will reflect the updated effective date in addition to the modifications. It is recommended that users review this policy often.'
    ]
  },
  {
    title: 'Contact Us',
