...
const makeBlog = (
  ...
  last_editedBy: 'admin@cheapfloors.ae',
  Images_Alt_Text: title,
  Meta_Title: `${title} | Cheap Floors`,
  Meta_description: `${title} — expert flooring guidance from Cheap Floors UAE.`,
  Canonical_Tag: `https://cheapfloors.ae/blogs/${redirectionUrl}`,
  isPublished: true,
  redirectionUrl,
  customUrl: null,
  comments: []
